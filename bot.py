...
from config import API_HASH, API_ID, LOGGER, BOT_TOKEN, TG_BOT_WORKERS, FORCE_SUB_CHANNEL, FORCE_SUB_CHANNEL_2, CHANNEL_ID, PORT
...
class Bot(Client):
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL_2:
            try:
                link_a = (await self.create_chat_invite_link(chat_id=FORCE_SUB_CHANNEL_2, creates_join_request=True)).invite_link 
